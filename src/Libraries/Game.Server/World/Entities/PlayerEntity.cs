...
public class PlayerEntity : Entity, IPlayerEntity, IDisposable
{
    ...
    public void SendChatMessage(string message)
    {
        ...
        {
            MessageType = (byte)ChatMessageType.Normal, Vid = Vid, Empire = (byte)Empire, Message = message
        };
    ...
    public void SendChatCommand(string message)
    {
        var chat = new ChatOutcoming
        {
            MessageType = (byte)ChatMessageType.Command, Vid = 0, Empire = (byte)Empire, Message = message
        };
        Connection.Send(chat);
    }
    ...
    public void SendChatInfo(string message)
    {
        var chat = new ChatOutcoming
        {
            MessageType = (byte)ChatMessageType.Info, Vid = 0, Empire = (byte)Empire, Message = message
        };
        Connection.Send(chat);
    }
