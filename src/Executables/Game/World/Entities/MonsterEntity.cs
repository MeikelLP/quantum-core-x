...
public class MonsterEntity : Entity
{
    ...
    public override void Die()
    {
        ...
        var dead = new CharacterDead(Vid);
        foreach (var entity in NearbyEntities)
        {
            if (entity is PlayerEntity player)
            {
    ...
    public override void ShowEntity(IConnection connection)
    {
        ...
        connection.Send(new SpawnCharacter(
            ...
            _proto.Type,
            (ushort) _proto.Id,
            (byte) _proto.MoveSpeed,
            (byte) _proto.AttackSpeed,
            CharacterMovementType.Wait,
            []
        ));
    ...
    {
        connection.Send(new RemoveCharacter(Vid));
    }
