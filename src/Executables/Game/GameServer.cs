...
public class GameServer : ServerBase<GameConnection>
{
    ...
    public GameServer(IOptions<HostingOptions> hostingOptions,
        ...
        : base(logger, pluginExecutor, serviceProvider, "game", hostingOptions)
    {
