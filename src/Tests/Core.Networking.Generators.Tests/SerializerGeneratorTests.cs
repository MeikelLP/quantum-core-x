...
namespace QuantumCore.Core.Packets {
    ...
    [Fact]
    public void Class_Constants_ByReference()
    {
        var inputCompilation = CreateCompilation(@"
using QuantumCore.Networking;
...
public partial class DeleteCharacterFail
{
    [Field(0, Length = Constants.FieldLength)]
    public string Testificate { get; set; }
}");
...
namespace QuantumCore.Core.Packets {
    ...
    public partial class DeleteCharacterFail : IPacketSerializable
    {
        ...
        {
            bytes[offset + 0] = 0x0B;
            bytes.WriteString(this.Testificate, offset + 1, (int)10);
        }
        ...
        public static DeleteCharacterFail Deserialize(ReadOnlySpan<byte> bytes, in int offset = 0)
        {
            var __Testificate = (bytes[(offset + 0)..(offset + 0 + 10)]).ReadNullTerminatedString();
            var obj = new QuantumCore.Core.Packets.DeleteCharacterFail
            {
                Testificate = __Testificate
            };
            return obj;
        }
        ...
        public static async ValueTask<object> DeserializeFromStreamAsync(Stream stream)
        {
            ...
            try
            {
                var __Testificate = await stream.ReadStringFromStreamAsync(buffer, (int)10);
                var obj = new QuantumCore.Core.Packets.DeleteCharacterFail
                {
                    Testificate = __Testificate
                };
    ...
    [Fact]
    public void Class_Constants_ByReferenceAndByValue()
    {
        var inputCompilation = CreateCompilation(@"
using QuantumCore.Networking;
...
public partial class DeleteCharacterFail
{
    [Field(0, Length = Constants.FieldLength + 5)]
    public string Testificate { get; set; }
}");
...
namespace QuantumCore.Core.Packets {
    ...
    [Fact]
    public void Class_Constants_ByValue()
    {
        var inputCompilation = CreateCompilation(@"
using QuantumCore.Networking;
...
namespace QuantumCore.Core.Packets {
    ...
    public partial class Squidward : IPacketSerializable
    {
        public static byte Header => 0xff;
        public static byte? SubHeader => null;
        public static bool HasStaticSize => true;
        ...
        public static Squidward Deserialize(ReadOnlySpan<byte> bytes, in int offset = 0)
        {
            var __IsHandsome = bytes[(offset + 0)] == 1;
            var obj = new QuantumCore.Core.Packets.Squidward
            {
                IsHandsome = __IsHandsome
            };
            return obj;
        }
        ...
        public static async ValueTask<object> DeserializeFromStreamAsync(Stream stream)
        {
            ...
            try
            {
                var __IsHandsome = await stream.ReadValueFromStreamAsync<Boolean>(buffer);
                var obj = new QuantumCore.Core.Packets.Squidward
                {
                    IsHandsome = __IsHandsome
                };
