...
// {
//     object GetContext(PacketHeaderDefinition header, IConnection connection, IPacket packet);
...
// {
//     record CacheInfo (Action<object, IConnection> ConnectionSetter, Action<object, IPacket> PacketSetter, Func<object> ContextGetter, Action<object> ContextReturner);
//
//
...
//     }
//
//     public object GetContext(PacketHeaderDefinition header, IConnection connection, IPacket packet)
//     {
...
//             var connectionSetterProperty = contextType.GetProperty(nameof(PacketContext<IConnection, IPacket>.Connection))!;
